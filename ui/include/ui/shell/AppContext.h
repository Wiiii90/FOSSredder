...
class AppContext : public QObject {
  ...
  Q_PROPERTY(ui::Navigation* navigation READ navigation WRITE setNavigation
  ...
  Q_PROPERTY(
      ui::Status* status READ status WRITE setStatus NOTIFY statusChanged)
  ...
  Q_PROPERTY(ui::AnalysisViewModel* analysisViewModel READ analysisViewModel
                 WRITE setAnalysisViewModel NOTIFY analysisViewModelChanged)
  ...
  Q_PROPERTY(ui::ImportViewModel* importViewModel READ importViewModel WRITE
                 setImportViewModel NOTIFY importViewModelChanged)
  Q_PROPERTY(ui::SettingsViewModel* settingsViewModel READ settingsViewModel
                 WRITE setSettingsViewModel NOTIFY settingsViewModelChanged)
...
public:
  ...
  ui::Actions* actions() const noexcept {
    return actions_;
  }
  ui::Navigation* navigation() const noexcept {
    return navigation_;
  }
  ui::FileSystemBrowser* fileSystemBrowser() const noexcept {
    return fileSystemBrowser_;
  }
  ui::Status* status() const noexcept {
    return status_;
  }
   ...
   */
  void setNavigation(ui::Navigation* value);
  /**
   ...
   */
  void setStatus(ui::Status* value);
  /**
...
private:
  ...
  ui::Navigation* navigation_ = nullptr;
