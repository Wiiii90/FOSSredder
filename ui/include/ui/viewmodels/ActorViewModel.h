...
private:
  ...
  /**
   * @brief Creates or updates an actor through the workspace facade.
   * @param id Existing actor id, or empty for create.
   * @param name Actor name.
   * @param aliases Actor aliases.
   * @param contractIds Linked contract ids.
   * @return Saved actor id.
   */
  ...
  /**
   * @brief Deletes an actor through the workspace facade.
