 ...
 * @brief Declares the QML API for the Property view.
 */
...
/**
 * @brief Owns editable property UI state and delegates property CRUD to
 * workspace.
 */
...
public:
  /**
   * @brief Creates the property view model bound to workspace roles.
   * @param parent Optional QObject parent.
   */
  explicit PropertyViewModel(WorkspaceStore* store, WorkspaceCommands* commands,
  ...
  /**
   * @brief Returns the editable property name.
  ...
  /**
   * @brief Updates the editable property name.
   * @param value New form name.
   */
  void setName(const QString& value);
  /**
   * @brief Returns editable property aliases.
  ...
  /**
   * @brief Replaces editable property aliases.
  ...
  /**
   * @brief Returns selected contract ids in the property form.
  ...
  /**
   * @brief Replaces selected contract ids in the property form.
   * @param value New selected contract ids.
   */
  void setSelectedContractIds(const QVariantList& value);
  /**
   * @brief Checks whether the form edits an existing property.
   * @return `true` when a property id is selected.
   */
  bool isEdit() const;
  /**
   * @brief Checks whether the editable form differs from the loaded property.
   ...
   * @return `true` when the property name field is not blank.
   */
  ...
  /**
   * @brief Adds an alias to the property form.
  ...
  /**
   * @brief Selects the previous property row.
   */
  Q_INVOKABLE void previous();
  /**
   * @brief Selects the next property row.
   */
  Q_INVOKABLE void next();
  /**
   * @brief Creates or updates the property through workspace commands.
   * @return Saved property id, or an empty string when submission fails.
   */
  Q_INVOKABLE QString submit();
  /**
   * @brief Deletes the selected property through workspace commands.
   */
  Q_INVOKABLE void deleteCurrent();
  /**
   * @brief Clears the editable property form.
   */
  Q_INVOKABLE void clear();
  /**
   * @brief Adds or removes a contract id from the property form selection.
...
signals:
  /** @brief Emitted when property view model state changed. */
  void changed();
...
private:
   ...
   * @param state Form state projected from a property row.
   */
  void applyFormState(const QVariantMap& state);
  /**
   * @brief Applies a reloaded form state when selection or workspace data
   * changes.
   * @param forceReload Whether to reload even if the owner id did not change.
   * @param state Form state projected from the selected property row.
   */
