...
class AnalysisViewModel : public QObject {
  ...
  Q_PROPERTY(QString exportStateJson READ exportStateJson WRITE
                 setExportStateJson NOTIFY changed)
  ...
  Q_PROPERTY(
      QVariantList previewTransactions READ previewTransactions NOTIFY changed)
  ...
  Q_PROPERTY(QString calcPercentText READ calcPercentText WRITE
                 setCalcPercentText NOTIFY changed)
  Q_PROPERTY(
      QString pendingAdjustmentsJson READ pendingAdjustmentsJson NOTIFY changed)
...
public:
  ...
  AnalysisWorkflow *analysisWorkflow() const noexcept {
    return analysisWorkflow_;
  }
