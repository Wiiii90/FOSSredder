/**
 * @file ui/include/ui/workspace/StatementListModel.h
 * @brief List model projecting workspace statement snapshots for QML bindings.
 */
...
class StatementListModel : public models::IndexedListModel<
