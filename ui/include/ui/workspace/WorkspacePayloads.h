...
QVariantMap validationResult(
    const core::ports::workspace::ValidationResult &result);
 ...
 */
QVariantMap propertyRow(
    const core::ports::workspace::PropertySnapshot &property);
 ...
 */
QVariantMap contractRow(
    const core::ports::workspace::ContractSnapshot &contract);
 ...
 */
QVariantMap analysisConfigRow(
    const core::ports::analysis::AnalysisConfigInput &config);
