/**
 * @file ui/tests/qml/settings/tst_SettingsSidebar.qml
...
TestCase {
    ...
    function test_SET_S_001_categoryRowsDelegateSelectionToSettingsState() {
        ...
        const importLabel = TestSupport.findRequired(Lookup, view, "settingsSidebarCategory_1")

        mouseClick(importLabel)
