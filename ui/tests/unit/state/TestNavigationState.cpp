/**
 * @file ui/tests/unit/state/TestNavigationState.cpp
...
TEST(NavigationStateTest,
     STATE_NAVIGATION_001_StoresAndExposesCurrentSectionAndSettingsCategory) {
...
TEST(NavigationStateTest,
     STATE_NAVIGATION_002_ExposesQmlSectionConstantsAndNavigatesByValue) {
  NavigationState navigation;
