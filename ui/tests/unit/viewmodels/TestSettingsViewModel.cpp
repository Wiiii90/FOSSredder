/**
 * @file ui/tests/unit/viewmodels/TestSettingsViewModel.cpp
...
TEST(SettingsViewModelTest, VM_SETTINGS_003_FileSelectionsUpdateSettingsStore) {
  ensureQtApplication();
...
TEST(SettingsViewModelTest, VM_SETTINGS_004_SettingsPropertiesDelegateToStore) {
  Settings settings;
  SettingsViewModel state;
  state.setSettings(&settings);
