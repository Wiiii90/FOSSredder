...
void AppContext::setAnnualViewModel(ui::AnnualViewModel* value) {
  assignIfChanged(annualViewModel_, value, this,
                  &AppContext::annualViewModelChanged);
}

void AppContext::setExportViewModel(ui::ExportViewModel* value) {
  assignIfChanged(exportViewModel_, value, this,
                  &AppContext::exportViewModelChanged);
}

void AppContext::setImportViewModel(ui::ImportViewModel* value) {
  assignIfChanged(importViewModel_, value, this,
                  &AppContext::importViewModelChanged);
}
