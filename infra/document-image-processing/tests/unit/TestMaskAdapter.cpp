/**
 * @file infra/document-image-processing/tests/unit/TestMaskAdapter.cpp
...
TEST(MaskAdapterTest, BuildsMaskAndWhiteoutFromProvidedBoxes) {
    ...
    const core::ports::document_image_processing::MaskRequest request{
        {},
        ...
        core::ports::document_image_processing::MaskRequest::Mode::Whiteout,
        {},
        false,
        false,
        false,
