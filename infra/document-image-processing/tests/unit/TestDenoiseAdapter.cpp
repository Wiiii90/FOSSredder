/**
 * @file infra/document-image-processing/tests/unit/TestDenoiseAdapter.cpp
...
namespace infra::document_image_processing::tests {
namespace {

class DenoiseAdapterTest : public ::testing::TestWithParam<core::ports::document_image_processing::DenoiseRequest::Method> {
protected:
...
TEST_P(DenoiseAdapterTest, WritesDenoisedImageForEachSupportedMethod) {
    ...
    const core::ports::document_image_processing::DenoiseRequest request{
        inputPath_,
        method,
        {}
    };
...
TEST(DenoiseAdapterTest, ReturnsEmptyResultForMissingFile) {
    ...
    const core::ports::document_image_processing::DenoiseRequest request{
        tempDir / "missing.png",
        core::ports::document_image_processing::DenoiseRequest::Method::Median,
        {}
    };
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        core::ports::document_image_processing::DenoiseRequest::Method::Median,
        core::ports::document_image_processing::DenoiseRequest::Method::Gaussian,
        core::ports::document_image_processing::DenoiseRequest::Method::Bilateral));
