/**
 * @file infra/document-image-processing/tests/unit/TestCropAdapter.cpp
...
TEST(CropAdapterTest, CropsInMemoryImageAndSkipsInvalidRectangles) {
    ...
    const std::vector<core::ports::document_image_processing::Rect> rects = {
        {10, 10, 40, 20},
        {70, 30, 80, 40},
        {5, 5, 0, 0},
    };
    ...
    const auto paths = opencv::CropAdapter::cropImages(
        ...
        rects,
        tempDir,
        core::ports::document_image_processing::CropRequest::OutputFormat::Png,
        92,
        &bytes,
        nullptr,
        "crop");
...
TEST(CropAdapterTest, WritesJpgFilesWhenRequested) {
    ...
    const auto paths = opencv::CropAdapter::cropImages(
        ...
        rects,
        tempDir,
        core::ports::document_image_processing::CropRequest::OutputFormat::Jpg,
        85);
