/**
 * @file infra/analysis-rendering/src/OpenCvAnalysisRendererAdapter.cpp
                        ...
                        const std::filesystem::path& outputPath)
{
    ...
    event.origin = "infra::analysis_rendering::OpenCvAnalysisRendererAdapter::renderToImage";
...
OpenCvAnalysisRendererAdapter::OpenCvAnalysisRendererAdapter(
    std::shared_ptr<core::ports::diagnostics::IErrorReporter> errorReporter)
    : errorReporter_(std::move(errorReporter))
{
}

bool OpenCvAnalysisRendererAdapter::renderToImage(const std::filesystem::path& outputPath,
                                                            ...
                                                            const core::ports::analysis::AnalysisResult& result) const
{
    ...
    try {
        ...
        core::errors::reportException(errorReporter_.get(),
                                      ...
                                      "infra::analysis_rendering::OpenCvAnalysisRendererAdapter::renderToImage",
