/**
 * @file
 * persistence/include/persistence/repositories/SqliteTransactionRepository.h
...
class SqliteTransactionRepository
    : public core::ports::repositories::ITransactionRepository {
public:
  /**
  ...
  /**
   * @brief Create a transaction repository using an existing database handle
   * wrapper.
   ...
   */
  void addTransaction(
      const std::shared_ptr<core::domain::Transaction>& transaction) override;
  ...
  getTransactions() const override;
   ...
   */
  std::optional<std::shared_ptr<core::domain::Transaction>>
  getTransactionById(const std::string& id) const override;
   ...
   */
  std::vector<std::shared_ptr<core::domain::Transaction>>
  getTransactionsForContract(const std::string& contractId) const override;
   ...
   */
  void assignTransactionsToContract(
      const std::string& contractId,
      const std::vector<std::string>& transactionIds) override;
