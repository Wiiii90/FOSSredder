...
class SqliteAnnualRepository
    : public core::ports::repositories::IAnnualRepository,
...
public:
  ...
  /**
   * @brief Create an annual repository using an existing database handle
   * wrapper.
   ...
   */
  std::vector<std::shared_ptr<core::domain::Annual>>
  getAnnuals() const override;
   ...
   */
  std::optional<std::shared_ptr<core::domain::Annual>>
  getAnnualById(const std::string& id) const override;
   ...
   */
  void
  updateAnnual(const std::shared_ptr<core::domain::Annual>& annual) override;
   ...
   */
  void
  upsertAnnual(const std::shared_ptr<core::domain::Annual>& annual) override;
