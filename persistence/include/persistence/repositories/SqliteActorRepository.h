...
class SqliteActorRepository
    : public core::ports::repositories::IActorRepository,
...
public:
  ...
  /**
   * @brief Create an actor repository using an existing database handle
   * wrapper.
   ...
   */
  std::optional<std::shared_ptr<core::domain::Actor>>
  getActorById(const std::string& id) const override;
