/**
 * @file
 * persistence/include/persistence/repositories/SqliteImportLogRepository.h
...
class SqliteImportLogRepository
    : public core::ports::repositories::IImportLogRepository {
public:
  /**
  ...
  /**
   * @brief Create an import log repository using an existing database handle
   * wrapper.
  ...
  getImportLogById(const std::string& id) const override;
