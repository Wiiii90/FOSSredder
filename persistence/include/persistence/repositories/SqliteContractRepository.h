...
class SqliteContractRepository
    : public core::ports::repositories::IContractRepository {
public:
  /**
  ...
  /**
   * @brief Create a contract repository using an existing database handle
   * wrapper.
   ...
   */
  void
  addContract(const std::shared_ptr<core::domain::Contract>& contract) override;

  /**
   * @brief Retrieve all contracts.
   * @return All stored contracts.
   */
  std::vector<std::shared_ptr<core::domain::Contract>>
  getContracts() const override;
   ...
   */
  std::optional<std::shared_ptr<core::domain::Contract>>
  getContractById(const std::string& id) const override;
   ...
   */
  void updateContract(
      const std::shared_ptr<core::domain::Contract>& contract) override;
   ...
   */
  std::vector<std::shared_ptr<core::domain::Contract>>
  getContractsForActor(const std::string& actorId) const override;
  /**
   ...
   */
  std::vector<std::shared_ptr<core::domain::Contract>>
  getContractsForProperty(const std::string& propertyId) const override;
  /**
  ...
  getActorIdsForContract(const std::string& contractId) const override;
  /**
   ...
   */
  std::vector<std::string>
  getPropertyIdsForContract(const std::string& contractId) const override;
