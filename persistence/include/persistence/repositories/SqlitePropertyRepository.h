...
class SqlitePropertyRepository
    : public core::ports::repositories::IPropertyRepository {
public:
  /**
  ...
  /**
   * @brief Create a property repository using an existing database handle
   * wrapper.
   ...
   */
  void
  addProperty(const std::shared_ptr<core::domain::Property>& property) override;

  /**
   * @brief Retrieve all properties.
   * @return All stored properties.
   */
  std::vector<std::shared_ptr<core::domain::Property>>
   ...
   */
  std::optional<std::shared_ptr<core::domain::Property>>
  getPropertyById(const std::string& id) const override;
   ...
   */
  void updateProperty(
      const std::shared_ptr<core::domain::Property>& property) override;
