/**
 * @file
 * persistence/include/persistence/repositories/SqliteStatementDraftRepository.h
...
class SqliteStatementDraftRepository
    : public core::ports::repositories::IStatementDraftRepository {
public:
  /**
   * @brief Create a statement draft repository for the database at the given
   * path.
  ...
  /**
   * @brief Create a statement draft repository using an existing database
   * handle wrapper.
   ...
   */
  void addStatementDraft(
      const std::shared_ptr<
          core::application::importing::draft::StatementDraft>& draft) override;
  ...
  getStatementDrafts() const override;
  ...
  std::optional<
      std::shared_ptr<core::application::importing::draft::StatementDraft>>
  getStatementDraftById(const std::string& id) const override;
