/**
 * @file
 * persistence/include/persistence/repositories/SqliteExportLogRepository.h
...
class SqliteExportLogRepository
    : public core::ports::repositories::IExportLogRepository {
public:
  /**
  ...
  /**
   * @brief Create an export log repository using an existing database handle
   * wrapper.
  ...
  getExportLogById(const std::string& id) const override;
