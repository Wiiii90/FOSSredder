...
inline core::domain::Alias
makeAlias(std::string value, std::string kind = "manual",
          std::string source = "tests",
          std::string createdAt = "2026-01-01T00:00:00Z",
          std::string updatedAt = "2026-01-02T00:00:00Z", int hitCount = 1,
          std::string lastUsedAt = "2026-01-03T00:00:00Z") {
  return core::domain::Alias(std::move(value), std::move(kind),
                             std::move(source), std::move(createdAt),
                             std::move(updatedAt), hitCount,
                             std::move(lastUsedAt));
}

inline std::shared_ptr<core::domain::Actor>
makeActor(const std::string& id = "actor-1") {
...
inline std::shared_ptr<core::domain::Property>
makeProperty(const std::string& id = "property-1") {
...
inline std::shared_ptr<core::domain::Contract>
makeContract(const std::string& id = "contract-1") {
...
inline std::shared_ptr<core::domain::Statement>
makeStatement(const std::string& id = "statement-1") {
...
inline std::shared_ptr<core::domain::Transaction>
makeTransaction(const std::string& id = "tx-1",
  ...
  transaction->setStatus(id == "tx-1"
                             ? core::domain::Transaction::Status::Verified
...
inline std::shared_ptr<core::domain::Analysis>
makeAnalysis(const std::string& id = "analysis-1") {
...
inline std::shared_ptr<core::domain::Annual>
makeAnnual(const std::string& id = "annual-1") {
...
inline core::application::importing::draft::TransactionDraft
makeTransactionDraft(const std::string& id = "draft-tx-1") {
...
inline core::application::importing::draft::StatementDraft
makeStatementDraft(const std::string& id = "statement-draft-1") {
  ...
  draft.createdAt = "2026-01-01T08:00:00Z";
  draft.updatedAt = "2026-01-02T08:00:00Z";
  draft.transactions = {makeTransactionDraft("draft-tx-1"),
                        makeTransactionDraft("draft-tx-2")};
  return draft;
}

inline core::application::importing::ImportLog
makeImportLog(const std::string& id = "import-log-1") {
...
inline core::application::exporting::ExportLog
makeExportLog(const std::string& id = "export-log-1") {
...
inline core::domain::catalog::WorkspaceCatalog makeWorkspaceCatalog() {
  ...
  catalog.setTransactions(
      {makeTransaction("tx-1", "statement-1", "property-1"),
...
inline core::application::workspace::WorkspaceSessionState
makeWorkspaceSessionState() {
  core::application::workspace::WorkspaceSessionState state;
  state.catalog = makeWorkspaceCatalog();
  state.workflow.statementDrafts = {
      std::make_shared<core::application::importing::draft::StatementDraft>(
          makeStatementDraft())};
  state.workflow.transactionDrafts = {
      std::make_shared<core::application::importing::draft::TransactionDraft>(
          makeTransactionDraft("draft-tx-1")),
      std::make_shared<core::application::importing::draft::TransactionDraft>(
          makeTransactionDraft("draft-tx-2"))};
  state.workflow.importLogs = {
      std::make_shared<core::application::importing::ImportLog>(
          makeImportLog())};
  state.workflow.exportLogs = {
      std::make_shared<core::application::exporting::ExportLog>(
          makeExportLog())};
  return state;
}
