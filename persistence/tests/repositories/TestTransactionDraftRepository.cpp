...
TEST(TransactionDraftRepositoryTest,
     AddsUpdatesRemovesAndClearsTransactionDrafts) {
  ...
  EXPECT_EQ(repo.getTransactionDraftById("draft-tx-1").value()->name,
            "Draft Rent");
